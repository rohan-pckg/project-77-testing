...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._ground_floor_select.onclick=function (e) {
			...
			me._floor_location.ggParameter.rx=10;me._floor_location.ggParameter.ry=10;
			me._floor_location.style[domTransform]=parameterToTransform(me._floor_location.ggParameter);
		...
		me._first_floor_select.onclick=function (e) {
			me._floor_location.style[domTransition]='none';
			me._floor_location.ggParameter.rx=60;me._floor_location.ggParameter.ry=10;
			me._floor_location.style[domTransform]=parameterToTransform(me._floor_location.ggParameter);
			if (player.transitionsDisabled) {
				me._floorplans.style[domTransition]='none';
			} else {
		...
		me._button_close.onclick=function (e) {
			...
			me._floorplan_open.ggParameter.sx=1;me._floorplan_open.ggParameter.sy=1;
			me._floorplan_open.style[domTransform]=parameterToTransform(me._floorplan_open.ggParameter);
			me._floorplan_close.style[domTransition]='none';
			me._floorplan_close.ggParameter.sx=0;me._floorplan_close.ggParameter.sy=0;
			me._floorplan_close.style[domTransform]=parameterToTransform(me._floorplan_close.ggParameter);
		}
		...
		hs='data:image/png;base64,'+
		...
		me._marker_node10.ggActivate=function () {
			...
			me._mh_radar.ggParameter.rx=134;me._mh_radar.ggParameter.ry=313;
		...
		me._marker_node1.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=107;me._mh_radar.ggParameter.ry=271;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_node2.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=52;me._mh_radar.ggParameter.ry=157;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_node4.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=105;me._mh_radar.ggParameter.ry=233;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_node3.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=123;me._mh_radar.ggParameter.ry=210;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_node5.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=161;me._mh_radar.ggParameter.ry=210;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_node6.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=191;me._mh_radar.ggParameter.ry=173;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_node7.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=229;me._mh_radar.ggParameter.ry=177;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_node8.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=200;me._mh_radar.ggParameter.ry=257;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_node9.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=229;me._mh_radar.ggParameter.ry=257;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_nodei1.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=114;me._mh_radar.ggParameter.ry=-227;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_nodei2.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=142;me._mh_radar.ggParameter.ry=-265;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_nodei3.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=144;me._mh_radar.ggParameter.ry=-226;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._marker_nodei4.ggActivate=function () {
			me._mh_radar.style[domTransition]='none';
			me._mh_radar.ggParameter.rx=104;me._mh_radar.ggParameter.ry=-262;
			me._mh_radar.style[domTransform]=parameterToTransform(me._mh_radar.ggParameter);
		}
		...
		me._floorplan_open.onclick=function (e) {
			...
			me._floor_plan_bg.ggParameter.rx=400;me._floor_plan_bg.ggParameter.ry=0;
			me._floor_plan_bg.style[domTransform]=parameterToTransform(me._floor_plan_bg.ggParameter);
			me._floorplan_open.style[domTransition]='none';
			me._floorplan_open.ggParameter.sx=0;me._floorplan_open.ggParameter.sy=0;
			me._floorplan_open.style[domTransform]=parameterToTransform(me._floorplan_open.ggParameter);
			me._floorplan_close.style[domTransition]='none';
			me._floorplan_close.ggParameter.sx=1;me._floorplan_close.ggParameter.sy=1;
			me._floorplan_close.style[domTransform]=parameterToTransform(me._floorplan_close.ggParameter);
		}
		...
		hs='data:image/png;base64,'+
		...
		for (var i = 0; i < me._ground_floor_trigger.childNodes.length; i++) {
			me._ground_floor_trigger.ggMarkerInstances.push(me._ground_floor_trigger.childNodes[i]);
		}
		...
		for (var i = 0; i < me._first_floor_trigger.childNodes.length; i++) {
			me._first_floor_trigger.ggMarkerInstances.push(me._first_floor_trigger.childNodes[i]);
		}
		me._floor_location.style[domTransition]='none';
		me._floor_location.ggParameter.rx=10;me._floor_location.ggParameter.ry=10;
		me._floor_location.style[domTransform]=parameterToTransform(me._floor_location.ggParameter);
		var clonedNormalElement = new SkinElement_mhn_Class(this,me._marker_node10);
		...
		var clonedActiveElement = new SkinElement_mha_Class(this,me._marker_node10);
		...
		var clonedNormalElement = new SkinElement_mhn_Class(this,me._marker_nodei1);
		...
		var clonedActiveElement = new SkinElement_mha_Class(this,me._marker_nodei1);
		...
		if (me._marker_nodei1.firstChild) {
			me._marker_nodei1.insertBefore(me._marker_nodei1__active,me._marker_nodei1.firstChild);
		} else {
			me._marker_nodei1.appendChild(me._marker_nodei1__active);
		}
		if (me._marker_nodei1.firstChild) {
			me._marker_nodei1.insertBefore(me._marker_nodei1__normal,me._marker_nodei1.firstChild);
		} else {
		...
		var clonedNormalElement = new SkinElement_mhn_Class(this,me._marker_nodei2);
		...
		var clonedActiveElement = new SkinElement_mha_Class(this,me._marker_nodei2);
		...
		if (me._marker_nodei2.firstChild) {
			me._marker_nodei2.insertBefore(me._marker_nodei2__active,me._marker_nodei2.firstChild);
		} else {
			me._marker_nodei2.appendChild(me._marker_nodei2__active);
		}
		if (me._marker_nodei2.firstChild) {
			me._marker_nodei2.insertBefore(me._marker_nodei2__normal,me._marker_nodei2.firstChild);
		} else {
		...
		var clonedNormalElement = new SkinElement_mhn_Class(this,me._marker_nodei3);
		...
		var clonedActiveElement = new SkinElement_mha_Class(this,me._marker_nodei3);
		...
		if (me._marker_nodei3.firstChild) {
			me._marker_nodei3.insertBefore(me._marker_nodei3__active,me._marker_nodei3.firstChild);
		} else {
			me._marker_nodei3.appendChild(me._marker_nodei3__active);
		}
		if (me._marker_nodei3.firstChild) {
			me._marker_nodei3.insertBefore(me._marker_nodei3__normal,me._marker_nodei3.firstChild);
		} else {
		...
		var clonedNormalElement = new SkinElement_mhn_Class(this,me._marker_nodei4);
		...
		var clonedActiveElement = new SkinElement_mha_Class(this,me._marker_nodei4);
		...
		if (me._marker_nodei4.firstChild) {
			me._marker_nodei4.insertBefore(me._marker_nodei4__active,me._marker_nodei4.firstChild);
		} else {
			me._marker_nodei4.appendChild(me._marker_nodei4__active);
		}
		if (me._marker_nodei4.firstChild) {
			me._marker_nodei4.insertBefore(me._marker_nodei4__normal,me._marker_nodei4.firstChild);
		} else {
		...
		var clonedNormalElement = new SkinElement_mhn_Class(this,me._markertemplate);
		...
		var clonedActiveElement = new SkinElement_mha_Class(this,me._markertemplate);
		...
		player.addListener('imagesready', function() {
			...
			me._loader.ggParameter.sx=0;me._loader.ggParameter.sy=0;
			me._loader.style[domTransform]=parameterToTransform(me._loader.ggParameter);
		});
		player.addListener('beforechangenode', function() {
			me._loader.style[domTransition]='none';
			me._loader.ggParameter.sx=1;me._loader.ggParameter.sy=1;
			me._loader.style[domTransform]=parameterToTransform(me._loader.ggParameter);
		});
	};
